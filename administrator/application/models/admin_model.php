...
class Admin_model extends CI_Model {
    ...
    function guardar_categorias($datos){        
    ...
    function actualizar_categorias($datos, $id){
    ...
    function guardar_subcategorias($datos){        
        return $this->db->insert('subcategoria', $datos);
    }

    function obtener_subcategoria($id){
        $query = $this->db->get_where('subcategoria', array('codsubcat'=>$id));
        return $query->row_array();
    }

    function actualizar_subcategorias($datos, $id){
        $this->db->where('codsubcat', $id);
        return $this->db->update('subcategoria', $datos);
    }
