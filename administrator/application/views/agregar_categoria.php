<?php $this->load->view('header')?>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">                                        
                    <form role="form" action="<?php echo base_url()?>agregar_categoria" method="post">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-3">
                                <label>Imagen</label>
                                <input type="hidden" name="imagen" id="cat-img">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-lg-6 img-container">
                                <img src="<?php echo base_url('images/info/categorias')?>/default.png" db-name="default" class="active"/>
